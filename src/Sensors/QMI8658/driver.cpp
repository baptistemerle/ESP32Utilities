#include "ESP32Utilities/Sensors/QMI8658/driver.h"
...
esp_err_t Driver::init(i2c_master_bus_handle_t bus_handle)
{
...
esp_err_t Driver::getValues(float& x, float& y, float& z) const
{
  uint8_t buffer[6];
...
esp_err_t Driver::readRegisters(uint8_t reg, uint8_t* data, size_t len) const
{
